        ...
        <div className="text-center mb-10">
          ...
          <div className="flex overflow-x-auto gap-3 snap-x snap-mandatory hide-scrollbar justify-start md:justify-center pb-2">
            <button
              ...
              className={`snap-center flex-shrink-0 px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 border ${activeCategory === null
            ...
            {categories.map((cat, idx) => (
              <button
                ...
                className={`snap-center flex-shrink-0 px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 border ${activeCategory === cat.id
                    ? "bg-gold border-gold text-jet-black shadow-[0_0_15px_rgba(212,175,55,0.3)]"
                    : "bg-white/5 border-white/10 text-white/60 hover:text-white hover:border-white/30"
                  }`}
              >
