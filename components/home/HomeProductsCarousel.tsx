        ...
        <div className="flex overflow-x-auto gap-4 snap-x snap-mandatory hide-scrollbar pb-6">
          {shopProducts && shopProducts.length > 0 ? (
            shopProducts.map((prop, idx) => {
              ...
              return (
                <Link href={`/${locale}/shop`} key={idx} className="group flex flex-col bg-charcoal/20 border border-white/5 rounded-2xl overflow-hidden hover:border-gold/30 transition-all h-full shadow-lg w-[75vw] sm:w-[45vw] md:w-[30vw] lg:w-[22vw] shrink-0 snap-start">
